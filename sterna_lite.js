...
// include: F:\emsdk\upstream\emscripten\src\emrun_prejs.js
/**
 * @license
...
// end include: F:\emsdk\upstream\emscripten\src\emrun_prejs.js
...
function jsHaveJspi() { return typeof Asyncify !== "undefined" && !!Asyncify.makeAsyncFunction && (!!WebAssembly.Function || !!WebAssembly.Suspending); }
function __asyncjs__qt_asyncify_suspend_js() { return Asyncify.handleAsync(async () => { if (Module.qtSuspendId === undefined) Module.qtSuspendId = 0; ++Module.qtSuspendId; await new Promise(resolve => { Module.qtAsyncifyWakeUp = resolve; }); }); }
...
var wasmImports = {
  ...
  /** @export */
  __asyncjs__qt_asyncify_suspend_js,
  /** @export */
...
// include: F:\emsdk\upstream\emscripten\src\emrun_postjs.js
/**
 * @license
 * Copyright 2013 The Emscripten Authors
 * SPDX-License-Identifier: MIT
...
// end include: F:\emsdk\upstream\emscripten\src\emrun_postjs.js
